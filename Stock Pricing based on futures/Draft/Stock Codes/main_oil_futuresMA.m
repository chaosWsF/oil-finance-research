...
% in_sample_period = 8 * 12;   % industry
% in_sample_period = 10 * 12;   % green

for l=1:length(L)
    output_file='../../data/results/results_oil_ind_Lags/arabian/results_oil_ind_arabian_'+string(L(l))+'.xlsx';
    % output_file='../../data/results/results_oil_ind_Lags/brent/results_oil_ind_brent_'+string(L(l))+'.xlsx';
    % output_file='../../data/results/results_oil_ind_Lags/oilfut/results_oil_ind_oilfut_'+string(L(l))+'.xlsx';
    % output_file='../../data/results/results_oil_green_Lags/brent/results_oil_green_'+string(L(l))+'.xlsx';
    % output_file='../../data/results/results_oil_green_Lags/oilfut/results_oil_green_'+string(L(l))+'.xlsx';
    disp(output_file)
        ...
        for k=1:num_y
            ...
            for i=1:num_x
                ...
                results_CW_i_j_k=nwest(f_CW_i_j_k,...
                    ones(length(f_CW_i_j_k),1),nlag);  % h(j)
