...
% % green
% L = 3;
% in_sample_period = 4 * 12;
% nlag = 30;
% output_file='../../results/summary_green_brent.xlsx';
...
xlswrite(output_file,test_results,output_sheet,'c2');
output_sheet='Out-of-sample statistics';
xlswrite(output_file,R2OS,output_sheet,'c2');

% output_sheet='In-Sample';
% xlswrite(output_file,test_results,output_sheet,'h2');
% output_sheet='Out-of-sample statistics';
% xlswrite(output_file,R2OS,output_sheet,'g2');