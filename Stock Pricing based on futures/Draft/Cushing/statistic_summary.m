...
oilData = xlsread(input_file, 'oil_last', 'f610:f831');
oilAllData = xlsread(input_file, 'oil_last', 'b610:g831');
...
xlswrite(outputFile, summary_oil, 'stat', 'b2');
xlswrite(outputFile, summary_oil_trend, 'stat', 'b3');
xlswrite(outputFile, summary_stock, 'stat', 'b4');
