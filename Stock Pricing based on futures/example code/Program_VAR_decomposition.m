...
xlswrite(output_file,beta_hat,output_sheet,'m19');
xlswrite(output_file,beta_hat_E_hat_r,output_sheet,'b3');
xlswrite(output_file,beta_hat_CF,output_sheet,'e3');
xlswrite(output_file,beta_hat_DR,output_sheet,'h3');
