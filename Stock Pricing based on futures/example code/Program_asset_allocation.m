...
xlswrite(output_file,CER_gain,output_sheet,'b6');
xlswrite(output_file,Sharpe,output_sheet,'b25');
xlswrite(output_file,CER_gain_GFC,output_sheet,'g6');
xlswrite(output_file,Sharpe_GFC,output_sheet,'g25');
xlswrite(output_file,CER_gain_pre,output_sheet,'l6');
xlswrite(output_file,Sharpe_pre,output_sheet,'l25');
