...
results_linear=ols(log_EWSI,X_linear);   % calculate log(EWSI_t) = a + bt
SII=zscore(results_linear.resid);    % residuals to be normalized
...
xlswrite(output_file,stats_GW,output_sheet,'b3');
xlswrite(output_file,rho_GW,output_sheet,'m3');
xlswrite(output_file,stats_short_interest,output_sheet,'b17');
xlswrite(output_file,decadal_mu,output_sheet,'h17');
xlswrite(output_file,rho_SII,output_sheet,'m18');
output_file='Returns_short_interest_results.xlsx';
output_sheet='SII trend analysis';
xlswrite(output_file,[z_lambda_md' z_lambda_md_cv'],output_sheet,'b3');
xlswrite(output_file,[t_lambda' t_lambda_cv'],output_sheet,'e3');
xlswrite(output_file,MZ_GLS,output_sheet,'h3');
xlswrite(output_file,MZ_GLS_cv',output_sheet,'i3');
xlswrite(output_file,ADF_GLS,output_sheet,'k3');
xlswrite(output_file,ADF_GLS_cv',output_sheet,'l3');
output_file='Returns_short_interest_results.xlsx';
output_sheet='Predictor correlations';
xlswrite(output_file,predictor_correlation,output_sheet,'b2');

% Compute cumulative returns

h=[1 3 6 12];    % calculate MA in 1, 3, 6, 12 months
...
beta_hat=nan(size(GW,2)+1,4,length(h));    % get num of column of GW
...
xlswrite(output_file,beta_hat(:,:,1),output_sheet,'b3');
xlswrite(output_file,beta_hat_PC_SII(1,:,1),output_sheet,'b18');
xlswrite(output_file,IVX_Wald(:,1),output_sheet,'b20');
xlswrite(output_file,qLL_hat(1),output_sheet,'b23');
xlswrite(output_file,beta_hat(:,:,2),output_sheet,'g3');
xlswrite(output_file,beta_hat_PC_SII(1,:,2),output_sheet,'g18');
xlswrite(output_file,IVX_Wald(:,2),output_sheet,'g20');
xlswrite(output_file,qLL_hat(2),output_sheet,'g23');
xlswrite(output_file,beta_hat(:,:,3),output_sheet,'l3');
xlswrite(output_file,beta_hat_PC_SII(1,:,3),output_sheet,'l18');
xlswrite(output_file,IVX_Wald(:,3),output_sheet,'l20');
xlswrite(output_file,qLL_hat(3),output_sheet,'l23');
xlswrite(output_file,beta_hat(:,:,4),output_sheet,'q3');
xlswrite(output_file,beta_hat_PC_SII(1,:,4),output_sheet,'q18');
xlswrite(output_file,IVX_Wald(:,4),output_sheet,'q20');
xlswrite(output_file,qLL_hat(4),output_sheet,'q23');
...
xlswrite(output_file,R2OS_PR(:,:,1),output_sheet,'b3');
xlswrite(output_file,R2OS_alt_detrend(:,:,1),output_sheet,'b21');
xlswrite(output_file,R2OS_PR(:,:,2),output_sheet,'e3');
xlswrite(output_file,R2OS_alt_detrend(:,:,2),output_sheet,'e21');
xlswrite(output_file,R2OS_PR(:,:,3),output_sheet,'h3');
xlswrite(output_file,R2OS_alt_detrend(:,:,3),output_sheet,'h21');
xlswrite(output_file,R2OS_PR(:,:,4),output_sheet,'k3');
xlswrite(output_file,R2OS_alt_detrend(:,:,4),output_sheet,'k21');
output_sheet='Forecast encompassing';
xlswrite(output_file,lambda(:,1:2,1),output_sheet,'b4');
xlswrite(output_file,lambda(:,3:4,1),output_sheet,'n4');
xlswrite(output_file,lambda(:,1:2,2),output_sheet,'e4');
xlswrite(output_file,lambda(:,3:4,2),output_sheet,'q4');
xlswrite(output_file,lambda(:,1:2,3),output_sheet,'h4');
xlswrite(output_file,lambda(:,3:4,3),output_sheet,'t4');
xlswrite(output_file,lambda(:,1:2,4),output_sheet,'k4');
xlswrite(output_file,lambda(:,3:4,4),output_sheet,'w4');
