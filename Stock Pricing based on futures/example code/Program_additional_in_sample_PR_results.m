...
xlswrite(output_file,beta_hat_alt_detrend(:,:,1),output_sheet,'e3');
xlswrite(output_file,beta_hat_alt_detrend(:,:,2),output_sheet,'j3');
xlswrite(output_file,beta_hat_alt_detrend(:,:,3),output_sheet,'o3');
xlswrite(output_file,beta_hat_alt_detrend(:,:,4),output_sheet,'t3');
xlswrite(output_file,beta_hat_alt_return(:,:,1),output_sheet,'e8');
xlswrite(output_file,beta_hat_alt_return(:,:,2),output_sheet,'j8');
xlswrite(output_file,beta_hat_alt_return(:,:,3),output_sheet,'o8');
xlswrite(output_file,beta_hat_alt_return(:,:,4),output_sheet,'t8');
xlswrite(output_file,beta_hat_alt_SI(:,:,1),output_sheet,'e13');
xlswrite(output_file,beta_hat_alt_SI(:,:,2),output_sheet,'j13');
xlswrite(output_file,beta_hat_alt_SI(:,:,3),output_sheet,'o13');
xlswrite(output_file,beta_hat_alt_SI(:,:,4),output_sheet,'t13');
xlswrite(output_file,beta_hat_subsample(:,:,1),output_sheet,'e18');
xlswrite(output_file,beta_hat_subsample(:,:,2),output_sheet,'j18');
xlswrite(output_file,beta_hat_subsample(:,:,3),output_sheet,'o18');
xlswrite(output_file,beta_hat_subsample(:,:,4),output_sheet,'t18');
