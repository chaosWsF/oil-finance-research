...
L_arr = [1 3 6 12 18 24 30 36];
nlag_arr = [3 6 12 18 24 30 36];
...
for l = 1:length(L_arr)
    ...
    for nl = 1:length(nlag_arr)
        ...
        output_file = sprintf("./results/add/n1skew_reg/L%d_nlag%d.xlsx", L, nlag);
